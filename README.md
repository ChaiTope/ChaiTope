...
React 체스판 UI와 `chess.js` 기반 합법 수 처리, Stockfish Web Worker 분석 연동을 실험한 학습용 프로젝트입니다.
완성형 온라인 체스 서비스보다는 웹 기반 체스 구현과 엔진 분석 흐름을 이해하기 위한 프로토타입으로 정리하고 있습니다.

**Tech:** React, JavaScript, chess.js, Stockfish Web Worker
...
Java와 C++로 일부 문제를 풀어보며 언어별 기본 문법과 알고리즘 풀이 방식을 연습했던 초기 학습용 저장소입니다.
